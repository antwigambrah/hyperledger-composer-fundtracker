...
var NS = 'org.indetail.nebulaNetwork';
...
describe('#'+NS, function() {
    ...
    before(function() {
        ...
        .then(function() {
            ...
            return businessNetworkConnection.connectWithDetails('defaultProfile', 'nebula-network', 'admin', 'Xurw3yU9zI0l');
        });
    });
    ...
    describe('ChangeAssetValue()', function() {
        ...
        var factory = businessNetworkConnection.getBusinessNetwork().getFactory();
            ...
            // create a user
            var user = factory.newResource(NS, 'User', 'Yves Peckstadt');
